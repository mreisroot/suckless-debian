...
sudo su <<- EOF
  ...
  user="$user"
  home="$home"
  dependencies="build-essential tcc xserver-xorg-core xserver-xorg-video-intel x11-xkb-utils x11-utils libx11-dev libxinerama-dev libxft-dev x11-xserver-utils xinit pkg-config xbacklight alsa-utils vim tmux rxvt-unicode lynx pass pcmanfm"
